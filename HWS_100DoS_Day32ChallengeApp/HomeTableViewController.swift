...
class HomeTableViewController: UITableViewController {
    ...
    @objc func addItem() {
        let alert = UIAlertController(title: "Add item to list?", message: nil, preferredStyle: .alert)
    ...
    @objc func resetList() {
        let alert = UIAlertController(title: "Reset the list?", message: "This will delete all current shopping items", preferredStyle: .alert)
